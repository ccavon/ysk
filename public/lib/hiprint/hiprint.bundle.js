...
var hiprint = function (t) {
    ...
    var _r,
        ...
        Zt = function () {
            ...
            function t(t, e, n, i, o, r, a, p, s, l, u, z) {
                this.defaultPaperNumberFormat = 
                "paperNo-paperCount", 
                this.printLine = 0, 
                this.templateId = t, 
                this.width = hinnn.mm.toPt(e), 
                this.height = hinnn.mm.toPt(n), 
                this.mmwidth = e, 
                this.mmheight = n, 
                this.paperHeader = i, 
                this.paperFooter = o, 
                this.contentHeight = o - i, 
                this.createTarget(), 
                this.index = l, 
                this.paperNumberLeft = r || parseInt((this.width - 30).toString()), 
                this.paperNumberTop = a || parseInt((this.height - 22).toString()), 
                this.paperNumberDisabled = p,
                this.paperNumberFormat = s, 
                this.hasPageNumber = z,
                this.referenceElement = u ? $.extend({}, u) : new zt({
                    top: 0,
                    left: 0,
                    height: 0,
                    width: 0,
            ...
            return t.prototype.subscribePaperBaseInfoChanged = function (t) {
                ...
                console.log(this)
                if (n.length || this.hasPageNumber) return n.html(t), n;
                var i = $('<span class="hiprint-paperNumber"  style="position: absolute"></span>');
